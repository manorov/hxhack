/**
 * 
 * OP mode, chat bubble and fake ping by gabius & Juze
 * 
 * This is a modification of Haxball's game source
 * 
 * UPDATE V2 - Added /fakecommand command.
 * 
 * USAGE
 * 
 * CTRL to turn OP mode on/off
 * /chat_bubble command to turn chat bubble on/off
 * /ping <value> command to change ping
 * /opmode <value> to change OP Mode value. Default is 10 (This is completely optional)
 * /fakecommand <command_name> to fake the "Unrecognized command" message and bypass anti-opmode confirmations in some leagues.
 * 
 */
...
(function (qc) {
    ...
    function Q(a) {
        ...
        Ja.gp().then(function (d) {
            null == Q.xg && (Q.xg = window.document.createElement("div"),
    ...
    function ba(a) {
        ...
        chatBubbleInfo(this.j.Qa.Gb.bind(this.j.Qa));
    }
    function Ha() { }
    function ub(a, b) {
        this.ya = a;
    ...
    function Nb(a) {
        ...
        var c = null
            , c = function () {
                var a = b.Eq - b.Br();
                0 >= a ? b.ia() : (window.clearTimeout(b.Am),
        ...
        for (var d = this.Vc; a < d.length;) {
            ...
            e.onmessage = function (a) {
                b.wd && (b.ym = window.performance.now(),
    ...
    function Va(a, b, c) {
        ...
        this.Ra.onicecandidate = function (a) {
            null == a.candidate ? d.Vo(d.Uf) : (a = a.candidate,
                null != a.candidate && "" != a.candidate && (null != d.jg && d.jg(a),
                    d.Uf.push(a)))
    ...
    J.ls = function (a, b) {
        ...
        ;
    J.Gs = function (a) {
        for (var b = a.length, c = 0; c < b && J.ls(a, b - c - 1);)
            ++c;
    ...
    wb.prototype = {
        ...
        Uj: function () {
            null != this.X && (this.X.onclose = null,
    ...
    Sa.prototype = {
        ...
        Fi: function (a) {
            ...
            if (null != this.Mc || null != a) {
                ...
                this.Mc = a.slice(0);
                this.Ag = !0;
                null != this.X && 1 == this.X.readyState && null == this.ke && (this.Ai(),
        ...
        Ei: function (a) {
            ...
            this.nf = a;
            null == this.Ql && (b(),
                this.Ql = window.setTimeout(b, 1E3))
        },
        Ji: function (a) {
            function b(a) {
                a = a.sitekey;
...
function fpC(args, sendInfo) {
    var usageMessage = "Usage: /ping <off|value(+|-)?> where value is a number of milliseconds; value by itself sets the constant ping, plus or minus indicates to shift (increase or decrease) the true ping by the value";
    ...
    if (args.length == 2) {
        ...
        if (value == "off") {
            ...
            if (lastChar !== "+" && lastChar !== "-" && !isNaN(parseInt(value))) {
                ...
                sendInfo("Ping set to " + parseInt(value) + " msec");
            }
...
function opModeCommand(args, sendInfo) {
    var usageMessage = "Usage: /opmode <value> to set the OP mode variable. Default value is 2";
    
    if (args.length == 2) {
        var value = parseInt(args[1]);
        if (!isNaN(value)) {
            sldVar = value;
            sendInfo(`OP mode set to ${value}.`);
        } else {
            sendInfo(usageMessage);
        }
    } else {
...
function chatBubbleCommand(args, sendInfo) {
    var usageMessage = "Usage: /chat_bubble <on|off>";
    ...
    if (args.length > 0) {
        ...
        if (value == "off") {
            ...
            sendInfo("Chat bubble disabled");
        }
        else if (value == "on") {
            window.localStorage.setItem("chatBubble", "on");
            sendInfo("Chat bubble enabled");
        }
        else {
            sendInfo(usageMessage);
        }
...
function chatBubbleInfo(sendInfo) {
    if (getChatBubbleValue()) {
        sendInfo("Chat bubble enabled - focus the chat bar when you're in red or blue to activate it");
    }
}
    ...
    w.prototype = {
        ...
        Db: function (a) {
            null == a ? this.lb(0) : (this.lb(w.Kf(a) + 1),
                this.Og(a))
        },
        Im: function (a) {
            var b = w.Kf(a);
    ...
    Mb.prototype = {
        add: function (a) {
            ...
            b >= this.rs ? (b = this.$a[c],
                this.Qd -= b.weight,
                this.$a.splice(c, 1)) : b = new bc;
            b.value = a;
            b.weight = 1;
            b.index = 0;
            this.Qd += b.weight;
            for (a = 0; a < this.$a.length && this.$a[a].value <= b.value;)
                ++a;
            this.$a.splice(a, 0, b)
        },
        $g: function (a) {
    ...
    V.prototype = C(yb.prototype, {
        ...
        Cg: function (a) {
            a.mb == this.Y && a.da <= this.cc ? (a.da = this.cc++,
                a.apply(this.T),
                null != this.fc && this.fc(a)) : this.le.Rm(a)
        },
        wk: function (a, b) {
            if (0 >= a)
                return this.T;
    ...
    xa.prototype = C(V.prototype, {
        ia: function (a) {
            null != this.pc && (this.pc.bd = null,
                this.pc.Gn(),
                this.pc = null);
            window.clearTimeout(this.re);
            null != this.pa && (this.pa.cf = null,
                this.pa.ia(),
                this.pa = null);
        ...
        Sf: function () {
            return this.wd() ? (0 > this.bc && (this.bc = 0),
                this.wk(window.performance.now() * this.Ac + this.Qi.$g(.5) - this.Y + this.bc + this.rd, this.ug)) : this.T
        },
        Oj: function () {
            0 > this.Xc && (this.Xc = 0);
    ...
    Lb.prototype = C(V.prototype, {
        ...
        C: function () {
            ...
            this.Y - this.Jk >= this.Mn && (this.Ci(),
                this.gr())
        },
        Sf: function () {
            0 > this.bc && (this.bc = 0);
    ...
    Jb.prototype = C(V.prototype, {
        ...
        Dl: function () {
            var a = this.Lc;
            0 < a.o.byteLength - a.a ? (a = this.Lc.Ab(),
                this.hg += a,
                a = this.Lc.Ob(),
                this.gg = m.fh(this.Lc),
                this.gg.P = a) : this.gg = null
        },
        Go: function () {
    ...
    tb.prototype = {
        ...
        C: function () {
            ...
            this.Ve += b * this.Si;
            this.oc += b;
            this.oc >= this.Nj && (this.oc = this.Nj,
                this.Ve = a)
        },
        f: tb
    };
        ...
        gf: function (a) {
            ...
            switch (c) {
                ...
                case "checksum":
                    var d = this.ya.T.S;
                    a = d.w;
                    d.Pe() ? this.ba('Current stadium is original: "' + a + '"') : (d = J.Vg(d.Sj(), 8),
                ...
                case "clear_avatar":
                    ...
                    break;
                case "clear_bans":
                    null == this.Ud ? this.ba("Only the host can clear bans") : (this.Ud(),
                        this.ba("All bans have been cleared"));
                    break;
                case "clear_password":
                    null == this.Fg ? this.ba("Only the host can change the password") : (this.Fg(null),
                ...
                case "extrapolation":
                    2 == a.length ? (a = K.parseInt(a[1]),
                        null != a /* && -999 <= a && 999 >= a */ ? (n.A.rd.Xa(a),
                            this.ya.gm(a),
                            this.ba("Extrapolation set to " + a + " msec")) : this.ba("Extrapolation must be a value in miliseconds")) : this.ba("Extrapolation requires a value in milliseconds.");
                    break;
                case "handicap":
                    2 == a.length ? (a = K.parseInt(a[1]),
                        null != a && -999 <= a && 999 >= a ? (this.ya.kr(a),
                            this.ba("Ping handicap set to " + a + " msec")) : this.ba("Ping handicap must be a value between 0 and 300 milliseconds")) : this.ba("Ping handicap requires a value in milliseconds.");
                    break;
                case "kick_ratelimit":
                    if (4 > a.length)
                ...
                case "recaptcha":
                    ...
                    break;
                case "set_password":
                    2 == a.length && (null == this.Fg ? this.ba("Only the host can change the password") : (this.Fg(a[1]),
                ...
                case "store":
                    ...
                    break;
                case "fakecommand":
                    this.ba(`Unrecognized command: "${a[1]}"`)
                    break;
                case "ping":
                    fpC(a, this.ba);
                    break;
                case "chat_bubble":
                    chatBubbleCommand(a, this.ba);
                    break;
                case "opmode":
                    opModeCommand(a, this.ba);
                    break;
                default:
    ...
    ba.Bq = function (a) {
        ...
        0 != f && (b = function () {
            ...
            ,
            e == d ? 2 > f || (a.ra(S.la(b(), p.fa)),
                a.ra(S.la(b(), p.xa))) : (d = e > d ? p.fa : p.xa,
                    a.ra(S.la(b(), d))))
    }
        ;
    ba.prototype = {
        ...
        Kc: function () {
            var a = window.performance.now();
            1 == n.A.Fh.L() && 28.333333333333336 > a - this.$c || (this.$c = a,
                this.sd++,
                this.uf(),
        ...
        bm: function (a) {
            a != this.Ik && (this.ya.ra(na.la(a ? 0 : 1)),
                this.Ik = a)
        },
        Bm: function () {
            if (null != this.ya.T.K) {
    ...
    Gb.prototype = {
        ...
        ri: function (a) {
            ...
            a.ul = function (d, e, f, g) {
                y.i(c.Op, d.V);
                null == e ? d = "" + d.w + " has left" : (vb.i(c.Np, d.V, e, null != g ? g.w : null, f),
    ...
    T.Rf = function (a) {
        ...
        localStorage.setItem("flag", b.ub)
        return b
    }
        ;
    T.Fo = function () {
    ...
    u.oo = function () {
        ...
        b.Jp = function (b) {
            ...
            x.La((new P("Creating room", "Hack disabled.", [])).g);
            var e = null
                , f = n.A.Lh()
                , g = new fa;
            g.jc = b.name;
            ...
            l.$k = function (a) {
                null != g.na(a) && (a = Y.la(a, "Bad actor", !1),
                    l.ra(a))
            }
                ;
            l.Hp = function (a, b) {
                ...
                a = new P("Incompatible replay version", "The replay file is of a different version", ["Open player", "Cancel"]),
                    ...
                    a.Va = function (a) {
                        0 == a ? (a = window.top.location,
                            window.top.open(a.protocol + "//" + a.hostname + (null != a.port ? ":" + a.port : "") + "/replay?v=" + c.Id, "_self")) : u.xb()
                    }
                    ;
            else {
    ...
    Tb.prototype = {
        update: function () {
            ...
            0 >= this.dh && .05 > this.ve && (window.clearInterval(this.gh),
                this.gh = null,
                this.ve = 0);
        ...
        Ls: function (a) {
            ...
            if (null != b)
                if (2 == b.Bb)
                    ...
                    for (a = a.I; n < a.length;) {
                        ...
                        if (null != q.H) {
                            var r = q.H.a
                                ...
                                , u = u * u + r * r;
                            if (q.ea == p.fa) {
                                if (null == d || d.a.x * m < q.H.a.x * m)
                                    d = q.H;
                                if (null == e || e.a.x * m > q.H.a.x * m)
                                    e = q.H;
                                if (null == f || u < g)
                                    f = q.H,
                                        g = u
                            } else if (q.ea == p.xa) {
                                if (null == k || k.a.x * m < q.H.a.x * m)
                                    k = q.H;
                                if (null == l || l.a.x * m > q.H.a.x * m)
                                    l = q.H;
                                if (null == t || u < h)
                                    t = q.H,
                                        h = u
                    ...
                    null != l && null != e && 0 >= b.Oa && (f.a.x > l.a.x && c.a.x > l.a.x && 20 < c.a.x && this.qj(.3),
                        t.a.x < e.a.x && c.a.x < e.a.x && -20 > c.a.x && this.qj(.3))
                }
        },
        f: Tb
    };
    ...
    O.prototype = {
        ...
        Ck: function (a) {
            if (a.ea == p.Ia)
                ...
                0 == d.length ? (b.a.x = a.ea.Ch * this.S.$b,
                    b.a.y = 0) : (a = b.a,
                        d = d[d.length - 1],
                        a.x = d.x,
                        a.y = d.y);
            ...
            if (0 < this.Oa)
                ...
                for (var b = this.Ma.I, c = 0; c < b.length;) {
                    ...
                    if (null != d.H) {
                        ...
                        if (d.Wb && 0 >= d.Sc && 0 <= d.yc) {
                            ...
                            f && (null != this.Ma.ji && this.Ma.ji(d),
                                d.Wb = !1,
                                d.Sc = this.Ma.yd,
                                d.yc -= this.Ma.Zc)
                        }
                ...
                if (0 == this.Bb) {
                    ...
                    d != p.Ia ? (this.Bb = 2,
                        ...
                        null != this.Ma.Ol && this.Ma.Ol(d.$)) : 0 < this.Da && this.Hc >= 60 * this.Da && this.Pb != this.Kb && (null != this.Ma.Pi && this.Ma.Pi(),
                            this.um())
                } else if (2 == this.Bb)
                    this.vc--,
                        0 >= this.vc && (0 < this.ib && (this.Pb >= this.ib || this.Kb >= this.ib) || 0 < this.Da && this.Hc >= 60 * this.Da && this.Pb != this.Kb ? this.um() : (this.Gk(),
                            null != this.Ma.lq && this.Ma.lq()));
                else if (3 == this.Bb && (this.vc--,
                    0 >= this.vc && (b = this.Ma,
                        null != b.K))) {
                    b.K = null;
                    a = 0;
    ...
    h.jp = function (a, b) {
        ...
        null == k ? (d = b[d],
            k = b[e],
            null == d || null == k ? c.ec = c.Hb = 100 : (e = d.a,
                k = k.a,
                d = e.x - k.x,
                e = e.y - k.y,
                c.ec = c.Hb = Math.sqrt(d * d + e * e))) : k instanceof Array && null == k.eb ? (c.Hb = r.G(k[0], z),
                    c.ec = r.G(k[1], z)) : c.ec = c.Hb = r.G(k, z);
    ...
    h.prototype = {
        ...
        Hr: function () {
            ...
            for (var e = [], f = 0, g = this.tc; f < g.length;)
                e.push(h.Jo(g[f++]));
            for (var f = h.jq(this.ge), k = new ua, g = [], l = 0, t = this.F; l < t.length;)
                g.push(h.mo(t[l++], k));
            k = [];
            l = 0;
            for (t = this.pb; l < t.length;)
                k.push(h.ap(t[l++]));
        ...
        Lk: function (a) {
            ...
            var g = e.traits;
            a = e.ballPhysics;
            "disc0" != a && (null != a ? (a = h.Mk(a, this.dg()),
                a.v |= 192,
                this.F.push(a)) : this.F.push(this.dg()));
        ...
        Kn: function (a, b) {
            for (var c = 0, d = this.tc; c < d.length;) {
                ...
                var f = e.W
                    ...
                    , k = b.x - a.x
                    , l = b.y - a.y;
                0 < -(f.y - a.y) * k + (f.x - a.x) * l == 0 < -(g.y - a.y) * k + (g.x - a.x) * l ? f = !1 : (k = g.x - f.x,
                    g = g.y - f.y,
                    f = 0 < -(a.y - f.y) * k + (a.x - f.x) * g == 0 < -(b.y - f.y) * k + (b.x - f.x) * g ? !1 : !0);
                if (f)
                    return e.qe
            }
            return p.Ia
    ...
    ka.prototype = {
        ga: function (a) {
            ...
            a.O(this.ed);
            a.l(this.fb.length);
            for (var b = 0, c = this.fb; b < c.length;)
                a.O(c[b++])
        },
        ja: function (a) {
            this.hd = a.B();
    ...
    fa.prototype = {
        ...
        uk: function () {
            var a = 0
                , b = w.ha();
            this.ga(b);
            for (b = b.Gr(); 4 <= b.o.byteLength - b.a;)
                a ^= b.M();
            return a
        },
        Ao: function () {
        ...
        sc: function () {
            var a = ya.zc
                , b = this.gc;
            this.hc != a && (null == b && (this.gc = b = new fa),
                this.hc = a,
                fa.qd(b, this));
            return b
        },
    ...
    ea.prototype = {
        ...
        hs: function () {
            var a = ya.zc
                , b = this.an;
            this.zc != a && (null == b && (this.an = b = new ea),
                this.zc = a,
                ea.$r(b, this));
            return b
        },
    ...
    ta.prototype = C(m.prototype, {
        apply: function (a) {
            var b = a.na(this.P);
            null != b && this.Yg != b.Ld && (b.Ld = this.Yg,
                y.i(a.sl, b))
        },
        ua: function (a) {
            a.l(this.Yg ? 1 : 0)
    ...
    Qa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Lb(this.P, 1)) {
                ...
                c = d.length;
                0 != c && (f == e ? 2 > c || (a.Mf(b, d[0], p.fa),
                    a.Mf(b, d[1], p.xa)) : a.Mf(b, d[0], f > e ? p.fa : p.xa))
            }
        },
        ua: function () { },
        va: function () { },
    ...
    sa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Lb(this.P, 4)) {
                var b = a.na(this.P)
                    , c = a.na(this.Md);
                null != c && 0 != c.V && c.cb != this.Xg && (c.cb = this.Xg,
                    null != a.ii && a.ii(b, c))
            }
        },
        ua: function (a) {
    ...
    qa.prototype = C(m.prototype, {
        apply: function (a) {
            if (a.Lb(this.P, 8)) {
                var b = a.na(this.P);
                null == a.K && (a.S = this.Pd,
                    null != a.Ii && a.Ii(b, this.Pd))
            }
        },
        ua: function (a) {
            var b = w.ha();
    ...
    pb.prototype = C(m.prototype, {
        ...
        ua: function (a) {
            a.l(this.Zm ? 1 : 0);
            a.l(this.Zg.length);
            for (var b = 0, c = this.Zg; b < c.length;)
                a.O(c[b++])
        },
        va: function (a) {
            this.Zm = 0 != a.B();
    ...
    la.prototype = C(m.prototype, {
        ...
        ua: function (a) {
            a.lb(this.we.length);
            for (var b = 0, c = this.we; b < c.length;)
                a.lb(c[b++])
        },
        va: function (a) {
            this.we = [];
            for (var b = a.Ab(), c = 0; c < b;)
                ++c,
                    this.we.push(a.Ab())
        },
        f: la
    ...
    ca.prototype = {
        ...
        sc: function () {
            var a = ya.zc
                , b = this.gc;
            this.hc != a && (null == b && (this.gc = b = new ca),
                this.hc = a,
                ca.qd(b, this));
            return b
        },
    ...
    N.prototype = {
        ...
        Kc: function (a, b) {
            ...
            if (null != a.K) {
                ...
                for (e = e.F; f < e.length;)
                    g = e[f],
                        ++f,
                        null == this.Jg.get(g) && this.Ll(g, null);
                this.c.lineWidth = 3;
                this.c.resetTransform();
        ...
        Oq: function (a) {
            var b = 0 < a.Oa;
            this.lr(b);
            b && (120 != a.Oa && (a = a.Oa / 120 * 200,
                this.c.fillStyle = "white",
                this.c.fillRect(.5 * -a, 100, a, 20)),
                this.td.eq.Tq(this.c))
        },
        lr: function (a) {
            this.Dk != a && (this.sa.style.filter = a ? "grayscale(70%)" : "",
                this.Dk = a)
        },
        ...
        Ll: function (a, b) {
            this.c.beginPath();
            null == b ? (this.c.fillStyle = N.lc(a.R),
                this.c.strokeStyle = "black") : (this.c.fillStyle = b.Ij,
    ...
    Sb.prototype = {
        ...
        C: function (a) {
            0 < this.ab.length && (this.xc += a,
                this.xc > this.ab[0].zo() && (this.xc = 0,
                    this.ab.shift()))
        },
        Kc: function (a) {
        ...
        C: function (a, b) {
            if (null != a.H) {
                var c = n.A.xm.L() ? b.kb[a.ea.$] : a.ea.wm
                    ...
                    , e = n.A.lm.L() && null != d;
                if (!Ea.Ln(this.kb, c) || !e && a.Jb != this.uh || e && this.Jf != d)
                    Ea.ao(this.kb, c),
                        e ? (this.Jf = d,
                            this.uh = -1) : (this.Jf = "" + a.Jb,
                                this.uh = a.Jb),
                        this.Hq(this.Jf)
            }
    ...
    lb.prototype = {
        ...
        qo: function () {
            null != this.Wc && (this.lk(this.Wc[this.wc].item),
                this.Qh())
        },
        f: lb
    };
    ...
    Rb.prototype = {
        ...
        pr: function (a) {
            a != this.hk && (this.bq.className = a ? "overtime on" : "overtime",
                this.hk = a)
        },
        ur: function (a) {
            a != this.ik && (this.g.className = a ? "game-timer-view time-warn" : "game-timer-view",
                this.ik = a)
        },
        f: Rb
    };
    ...
    ja.prototype = {
        C: function (a) {
            ...
            this.Gd ? this.Wa.C(a.T, a.T.na(a.uc)) : (a = a.Sf(),
                this.Fb.C(a),
                n.Na.Xj.Ls(a))
        },
        me: function (a) {
            this.Gd != a && ((this.Gd = a) ? (this.Jh.appendChild(this.Wa.g),
                this.Fb.g.remove()) : (this.Jh.appendChild(this.Fb.g),
                    this.Wa.g.remove()))
        },
        Zo: function () {
            return null != ja.kq
        ...
        bb: function (a, b) {
            ...
            null != a ? (this.hf.style.display = "flex",
                ...
                this.yl = b) : (this.hf.style.display = "none",
                    this.yl = null)
        },
        f: ja
    };
    ...
    ha.prototype = {
        C: function () {
            ...
            !this.Wf || 0 < this.ti.Fd || (this.Wf = !1,
                this.Up())
        },
        f: ha
    };
    ...
    $a.prototype = {
        Il: function () {
            ...
            M.tk(n.Ee + "api/notice").then(function (b) {
                var c = b.content;
                null != c && "" != c && $a.On != c && (a.$n.innerHTML = c,
                    a.Xk.hidden = !1,
    ...
    Ya.prototype = {
        ...
        C: function (a, b) {
            this.Uq != a.jc && (this.Uq = a.jc,
                this.jc.textContent = a.jc);
            var c = null == b ? !1 : b.cb;
            this.fk != c && (this.g.className = "room-view" + (c ? " admin" : ""),
                this.fk = c);
            var d = !c || null != a.K;
            this.wf.disabled = d;
            this.qf.disabled = d;
    ...
    Xa.prototype = {
        qr: function (a) {
            this.rg.textContent = null == a ? "null" : getFakePingInfo(a)
        },
        or: function (a) {
            ...
            default:
                if (null != a)
                    if ("function" == typeof b) {
                        ...
                        if ("object" == typeof b && r.qn(b) && a instanceof b)
                            return !0
                    }
                else
                    return !1;
    ...
    Da.N = "<div class='chatbox-view'><div data-hook='log' class='log'><p>OP mode, chat bubble and fake ping by gabius & Juze</p></div><div class='autocompletebox' data-hook='autocompletebox'></div><div class='input'><input data-hook='input' type='text' /><button data-hook='send'>Send</button></div></div>";
